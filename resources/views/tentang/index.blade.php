...
<div class="general-page">
                ...
                <div class="general-page__nav">
                    <div class="container general-page__nav_container">
                        <nav class="general-page__nav_inner"><a class="general-page__nav_link active" aria-current="true" href="{{asset('/tentang/index')}}">Tentang Capstone Indonesia</a><a class="general-page__nav_link" aria-current="false" href="{{asset('tentang/kontak')}}">Kontak Kami</a></nav>
                    </div>
                </div>
