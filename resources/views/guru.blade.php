    ...
    <div class="container login-page__container">
        <div class="login-page__box">
            ...
            <div class="login-page__tabs">
                <div class="login-page__tab-list"><a class="login-page__tab" aria-current="false" href="{{url('login')}}"><span>Murid</span></a><a class="login-page__tab login-page__tab--selected" aria-current="true" href="{{url('guru')}}"><span>Guru</span></a></div>
                <div class="login-page__tab-panel">
                    <div class="login-page__form">
                        ...
                        <div class="login-page__layout-forget"><a class="link login-page__link undefined" href="/forget-password">Lupa Kata Sandi</a><a class="link login-page__link undefined" href="/register">Daftar</a></div>
